...
# 
# The script generates controlled test data with known properties and tests
# various PSN parameter combinations to ensure both implementations produce
# identical results.
#
...
if $cv_mode >= 0:
    ...
    opt['cv_thresholds'] = list(range(1, max_dims + 1))
