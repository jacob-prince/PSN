...
function test_psn_all_combinations()
    ...
    [train_data, test_data, ground_truth] = simulate_data('generate_data', ...
        'nvox', 30, ...
        'ncond', 50, ...
        'ntrial', 3, ...
        'signal_decay', 2.0, ...
...
% TEST_INVALID_INPUTS Test that invalid inputs properly fail
    ...
    [train_data, ~, ~] = simulate_data('generate_data', ...
    ...
    [single_trial_data, ~, ~] = simulate_data('generate_data', ...
...
% following GSN's approach for computing average number of trials.
    ...
    [base_data, ~, ~] = simulate_data('generate_data', ...
